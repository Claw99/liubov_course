...
export const About = () => {
  ...
  return (
    <section className="bg-[#1a1612] pt-0 pb-16 px-5 overflow-hidden">
      <div className="max-w-xl mx-auto flex flex-col gap-5">
        {/* Заголовок секции */}
        <div className="text-center md:text-left pt-0 mt-0">
          <h3 className="bg-gradient-to-tr from-[#8a6d3b] via-[#f7f3e8] to-[#c5a059] bg-clip-text text-transparent drop-shadow-[0_3px_6px_rgba(0,0,0,0.5)] font-bold text-2xl uppercase tracking-[0.1em] leading-tight">
            ПРОЕКТ УПРАВЛЕНИЕ ЭНЕРГИЕЙ — ЭТО
          </h3>
          <div className="w-full max-w-[320px] md:max-w-[384px] h-[1px] bg-gradient-to-r from-transparent via-[#c5a059] to-transparent opacity-60 mt-4 mb-2 drop-shadow-[0_3px_6px_rgba(0,0,0,1)] mx-auto md:mx-0" />
        </div>
            ...
            >
              <div className="flex flex-row items-center gap-5 relative z-10">
                ...
                <div className="flex flex-col gap-1">
                  <h4 className="bg-gradient-to-bl from-[#8a6d3b] via-[#f7f3e8] to-[#c5a059] bg-clip-text text-transparent text-xl font-bold uppercase tracking-[0.1em] drop-shadow-[0_3px_6px_rgba(0,0,0,0.5)]">
                    {point.title}
                  </h4>
                  <p className="font-fira text-white/80 text-sm tracking-widest max-w-xl leading-snug drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
                    {point.text}
                  </p>
                </div>
              </div>

              {/* Стеклянные эффекты на фоне карточки */}
              ...
              <div className="absolute -bottom-10 -right-10 w-32 h-32 bg-[#c5a059]/10 blur-[40px] rounded-full" />
            </div>
          </div>
        ))}
      </div>
